...
* **SelfHear SSB** - Самоконтроль в моде SSB/AM, для DIGI/RTTY/LOOPBACK активен всегда
...
* **Auto Doppler** - Автоматически смещающет частоту трансивера исходя из расчитанного эффекта Доплера

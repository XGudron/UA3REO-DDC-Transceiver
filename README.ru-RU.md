...
* **FTx Auto CQ** - Автоматический переход в режим CQ после проведения связи FT8/FT4
* **FTx Freq** - Выбранная частота передачи
* **FTx Correct time** - Позволяет корректировать время на трансивере за счёт расчёта среднего отклонения от декодов FT8/FT4
...
### Pre-Distortion (Digital Pre Distortion экспериментально для Wolf-2)

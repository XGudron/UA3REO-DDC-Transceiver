...
* Возможна установка УКВ платы от Wolf-2 для расширения УКВ характеристик
* Два Антенных входа
* Виды модуляции (TX/RX): CW, LSB, USB, AM, FM, WFM, DIGI
* МШУ(LNA) и Предусилитель
* Регулируемый аттенюатор на 0-31дБ
...
* CAT виртуальный COM-порт (эмуляция TS-2000 / FT-450, DTR - CW)
* Работа по USB (передача звука, IQ, CAT, KEY, PTT)
* Самоконтроль, CW гаусс-фильтр
* RTTY/RDS/CW декодер
* FT8/FT4/FT2 декодер/энкодер
* RTTY/PSK31 декодер/энкодер
* Отправка лога связей и данных в лог https://allqso.ru/ и https://www.wavelog.org/
* Эквалайзер TX/RX, ревербератор, различные DSP компрессоры и пр.
* SSB/FM Режим сканера, быстрый переход между сигналами CW
* Режим WSPR маяка
* VOX / USB-VOX
* Поддержка SDHC/SDSC/SDXC карт памяти до 16 Гб
* Цифровой магнитофон, проигрывание сообщения в эфир
...
* Поддержка тангент Yaesu MH-48 и MH-36
* Режим аппаратной самодиагностики
* CTCSS-субтоны и 1750кгц стартовый тон для открытия репитеров
* Помощь операторам с нарушением зрения
* Цифровое предыскажение (Digital Pre Distortion)
* CW-тренажер
* Поддержка внешнего PTT-секвенсора для управления им через CAT и с трансивера
...
WiFi модуль ESP-01 должен иметь свежую прошивку из Dropbox<br>

## Функциональные кнопки

| Кнопка | Короткое | Длинное |
|--------|----------|---------|
| **A/B**, **XFC** | Выбор VFO A или B (XFC - во время нажатия) | То же |
| **A<>B**, **A / B** | Поменять VFO A и B | То же |
| **B=A**, **A->B** | Скопировать активный VFO в другой | То же |
| **SPLIT** | Split вкл/выкл | То же |
| **DOUBLE** | Двойной приём вкл/выкл | Режим смешивания: A&B стерео ↔ A+B |
| **POWER** | Окно/меню RF мощности | Режим внешнего УМ (PA) |
| **CESSB** | CESSB вкл/выкл | Меню CESSB |
| **DPD** | Цифровое предыскажение вкл/выкл | То же |
| **PRE** | LNA вкл/выкл | То же |
| **ATT** | Аттенюатор вкл/выкл | Шаг уровня ATT (дБ) |
| **NB** | Цикл NB: выкл → NB1 → NB2 → оба | Меню NB1/NB2 |
| **NOTCH** | Авто-notch вкл/выкл | Ручной notch |
| **DNR** | Следующий тип DNR (0…3) | То же |
| **AGC** | AGC вкл/выкл | То же |
| **FAST** | Быстрая перестройка | То же |
| **SQL** | Шумоподавитель вкл/выкл | Меню уровня squelch |
| **RIT** | RIT вкл/выкл | XIT / Сброс RIT |
| **XIT** | XIT вкл/выкл | RIT / Сброс XIT |
| **MONI** | Самоконтроль вкл/выкл | Настройки self-hear для моды |
| **VOX** | VOX вкл/выкл | Меню VOX |
| **SCAN** | Сканер вкл/выкл | То же |
| **AUTOGN** | Авто RF gain | То же |
| **BANDMP** | Карта диапазонов | То же |
| **BAND− / BAND+** | Предыд./след. диапазон | То же, но наоборот |
| **MODE− / MODE+** | Предыд./след. мода | То же, но наоборот |
| **FFT− / FFT+** | Уже / шире панорама | То же |
| **HPF** | Меню ФВЧ | То же |
| **BW** | Меню полосы RX | То же |
| **LENS** | Лупа FFT (zoom) | То же |
| **FILT 1…3** | Загрузить пресет фильтров | Сохранить текущие фильтры |
| **BALANCE** | Баланс A/B | То же |
| **ANT** | Следующая антенна TX/RX | То же |
| **RXANT** | Доп. RX-антенна (Wolf-2) | То же |
| **TUNE** | ATU вкл | Подстройка / несущая |
| **ATU RST** | Сброс памяти ATU на диапазоне | То же |
| **SWR** | КСВ-анализатор по диапазону | То же |
| **REPIT** | Режим репитера | Меню смещения репитера |
| **BREAKIN** | Break-in CW (ключ+PTT) | Тип CW PTT |
| **SNAP < / SNAP >** | Привязка частоты к сетке | Auto-snap |
| **M>VFO / VFO>M** | Чтение канала памяти (режим MEMO) | Запись канала |
| **MEMORY** | Окно каналов памяти | То же |
| **REC** | Запись на SD | То же |
| **PLAY** | Проигрывание последней записи | Передача записи в эфир |
| **FILES** | Файловый менеджер SD | То же |
| **SERVICE** | Меню сервисов | Скриншот на SD |
| **MENU** | Системное меню | Закрыть всё / скрытое меню |
| **LOCK** | Блокировка | То же |
| **FT8** | Сервис FT8 | То же |
| **WPM** | Скорость CW | То же |
| **PTT OFF** | Запрет TX | То же |
| **TX** | Программный PTT | То же |
| **ACCESS** | Озвучить частоту и моду (TTS) | То же |
| **EQ** | Эквалайзер TX/RX | То же |
| **SLEEP** | Режим сна LCD | То же |
| **DXCALL** | Окно корреспондента (touch) | То же |
| **DX KEYB** | Окно передачи CW сообщения в эфир | То же |
| **MACROS 1…8** | Макрос CW/SSB/RTTY/PSK | Редактор; Macro 1 длинное — Auto CQ |
| **NONE** | Не назначено | — |

Назначения меняются в *Settings → Front buttons*.

## Настройки

### Operator

* **Accessibility** - Помощь операторам с нарушением зрения, телеграфирование в динамик текущих параметров трансивера при переключении
* **Callsign** - Позывной пользователя (оператора)
* **Locator** - QTH локатор пользователя
* **Operator Name** - Имя оператора
* **QTH xxx** - Установка Широты\Долготы\Высоты вашего расположения для расчёта прохождения спутников
...
* **ENC2 Priority enbl** - Включение приоритетной функции энкодера, на которую происходит автоматическое переключение после 30сек бездействия
* **ENC2 Priority** - Выбор приоритетной функции вторичного энкодера
...
* **FAN Always on** - Принудительная активация работы вентилятора (для тяжелый условий)
...
* **DC Filter RX** - Включение DC-корректора на тракте приёма (срезают постоянную составляющую и часть НЧ частот)
* **DC Filter TX** - Включение DC-корректора на тракте передачи (срезают постоянную составляющую и часть НЧ частот)
* **DeEmphasis FM, us** - Настройка фильтра для уменьшения высокочастотных шумов при приёме NFM/WFM
...
* **RX Filter Margin** - Ширина фильтра относительно частот несущих сигналов
...
* **Dual RX** - Активация двойного приёмника
* **Dual RX Balance** - Баланс каналов в режимах двойного приёмника
* **Dual RX Type** - Тип смешивания сигналов двойного приёмника: A+B, A&B, A Only, B Only
* **Dual RX IQ** - Указывает источник (VFO) IQ сигнала для отправки в USB аудио-карту в режиме Dual RX
...
* **VAD SQL Threshold** - Выбор порога срабатывания VAD детектора голоса (шумоподавитель SQL для SSB моды и SCAN режима)
...
* **ATU AutoRun** - Автоматический запуск ATU при высоком КСВ
...
* **EXT PA mode** - Режим работы с внешним усилителем, применяются отдельно установленные калибровки RF Gain
* **EXT PTT in PA mode** - Подавать сигнал PTT на External разъём только в режиме "EXT PA mode"
* **INT ATU in PA mode** - Определяет, включать ли внутренний тюнер в режиме "EXT PA Mode"
* **EXT ATU in PA mode** - Определяет, блокировать ли внешний УМ пока настраивается внешний ATU
* **Input Auto Switch** - Автоматический выбор входа (PTT - микрофон, CAT - USB)
...
* **Pwr by main ENC** - Разрешить изменение мощности основным энкодером в TX режиме
...
* **SWR Hold Peaks** - Задерживать измеритель мощности на пиках мощности сигнала
...
* **TX Inhibit** - Запретить переход на передачу
* **Use Keyer for RTTY** - Разрешить использование CW ключа (или USB-COM линии ключа) для манипуляции в моде RTTY
...
* **USB VOX** - Активация ТХ при передаче звука в USB-аудио карту
...
* **Debounce Rate** - Порог срабатывания системы анти-дребезга CW ключа относительно длины точки
...
* **Add 2nd harmonics** - Искусственное добавление гармоник 2-го порядка в НЧ сигнал приёмника для симуляции нелинейности аналогового тракта
* **Add 3rd harmonics** - Искусственное добавление гармоник 3-го порядка в НЧ сигнал приёмника для симуляции нелинейности аналогового тракта
* **Add Asymmetry** - Искусственное добавление ассиметрии НЧ сигнала приёмника для симуляции нелинейности аналогового тракта
...
* **AF Monitor** - Отображение НЧ (аудио) сигнала в частотной и временной области под водопадом. Off - выключено, TX Only - только при передаче, Always - постоянно на приёме и передаче
* **AF Monitor Time** - Длина окна временной области AF Monitor
...
* **FFT 3D Slides** - Количество слайдов 3D FFT для отображении истории спектра
* **FFT 3D X Offset** - Настройка перспективы 3D FFT по X
* **FFT 3D Y Offset** - Настройка перспективы 3D FFT по Y
...
* **DX Cluster Type** - Выбор источника данных для DX Cluster (RBN, DXSummit, Telnet)
...
* **TELNET Cluster Host** - Адрес Telnet-сервера для DX-кластера
* **TELNET Cluster Port** - Порт Telnet-сервера для DX-кластера
* **Cluster Mask** - Фильтрация спотов кластера по маске позывного: * - любое количество символов, ? - один любой символ, цифры-буквы - полное соответствие. Например "?A3R*"
* **WOLF Cluster** - Отображать других пользователей трансивера Волк на спектре и передавать свои данные
* **WOLF Cluster Models** - Включает отображение моделей трансиверов пользователей в волк-кластере
...
* **FFT Window** - Выбор оконной функции FFT
...
* **CW Multi-Decoding** - Режим декода множества сигналов в полосе обзора
* **FTx Auto CQ** - Автоматический переход в режим CQ после проведения связи FT8/FT4/FT2
* **FTx Auto Frequency** - При включении (по умолчанию) при запуске декодера трансивер переключается на стандартную частоту FT8/FT4/FT2 для текущего диапазона; при выключении декодер работает на текущей частоте трансивера
* **FTx Freq** - Выбранная частота передачи
* **FTx Correct time** - Позволяет корректировать время на трансивере за счёт расчёта среднего отклонения от декодов FT8/FT4/FT2
* **PSK31 Freq** - Центральная частота несущей для PSK декодера/энкодера
...
* **WIFI NTP Server** - Выбор адреса NTP-сервера синхронизации времени
* **ALLQSO.RU Token/LogId** - Токен и ID лога на онлайн-журнале https://allqso.ru/
* **Wavelog** - Настрйоки интеграции с https://www.wavelog.org/
...
* **Profile Names** - Имена профилей (до 3 символов) для кнопок экспорта/импорта настроек и калибровок
...
* **EME Info** - Положение Луны и параметры EME-тракта для вашего QTH (см. [EME Info](#eme-info))
* **Select SAT** - Выбор спутника из скачанного TLE файла

### EME Info

Экран информации для работы Earth-Moon-Earth (EME), по аналогии с окном Astronomical Data в WSJT-X (но немного упрощены математически). Расчёты выполняются по текущим координатам QTH (настройки Operator) и частоте активного VFO; не зависят от спутника, выбранного в **Select SAT**.

* **MoonAz (азимут)** - Горизонтальное направление на Луну с вашего QTH, в градусах (0° — север, 90° — восток, 180° — юг, 270° — запад)
* **MoonEl (элевация)** - Угол места Луны над горизонтом на вашем QTH, в градусах
* **SelfDop (Self-Doppler Shift / собственный доплер)** - Двухстороннее доплеровское смещение собственного EME-эха (TX → Луна → RX)
* **Width (Doppler Spread / Libration Fading / разброс по частоте)** - Спектральное расширение («размытие») отражённого сигнала, вызванное либрацией Луны
* **Delay (Round-Trip Time / время туда-обратно)** - Точное время прохождения радиоволны от вашей антенны до Луны и обратно
* **Dec (склонение)** - Топоцентрическое склонение Луны, в градусах
* **SunAz** - Азимут Солнца на вашем QTH, в градусах
* **SunEl** - Угол места Солнца над горизонтом на вашем QTH, в градусах
* **Tsky** - Оценка температуры фона неба в направлении Луны, пересчитанная на рабочую частоту (отображается от 5 МГц и выше)
* **Dpol** - Пространственное смещение поляризации, в градусах; разность между вашей станцией и DX, если **DX Call** задан и распознан
* **Dist (дистанция)** - Топоцентрическое расстояние от вашей станции до Луны, км
* **Dgrd** - Оценка деградации сигнала в dB относительно лучших условий (Луна в перигее, холодное небо)

Следующие поля отображаются **только при заполненном DX Call** (позывной корреспондента из окна **DXCALL**):

* **DX Call** - Позывной корреспондента для расчёта DX-тракта
* **DX Loc** - Maidenhead-локатор, вычисленный по координатам DX-станции
* **DxAz** - Азимут на Луну с QTH DX-станции, в градусах
* **DxEl** - Угол места Луны на QTH DX-станции, в градусах
* **DxDop** - Односторонний доплер на DX-станции, Гц
* **DxWid** - Разброс по частоте «от края до края» диска Луны на DX-станции, Гц
* **MNR** - Максимальная нереципрокность EME-тракта в dB из-за пространственной поляризации
...
* **CAT Transverters IF** - При использовании трансвертера, отдавать в CAT частоту ПЧ или частоту VFO
* **COM CAT DTR/RTS** - Настройка функций управляющих линий DTR/RTS порта CAT
* **Second COM Mode** - Выбор режима работы вторичного COM-порта (отладка, CAT, CW/RTTY DATA, мост к ESP модулю)
...
* **Inhibit VOX Button** - Отключает аппаратную кнопку VOX
...
* **External ATT** - Подключение управления для внешнего аттенюатора 3-6-12дБ (Wolf-2)
...
* **Invert LCD PWM** - Инвертирование ШИМ подсветки экрана RA8875
...
* **Mute AF AMP on TX** - Отключать УНЧ трансивера во время передачи (при отсутствии самоконтроля)
...
* **Touchpad Offset X/Y** - Позволяют задать смещение для точки нажатия на тачпад (при работе под углом к экрану или аппаратными проблемами)
...
* **VBAT Rechargable** - Включить подзарядку аккумулятора, если установлен вместо батареи
* **VHF Mixer Board** - Включение поддержки УКВ платы с смесителем
* **VHF Mixer IF, MHz** - Выбор частоты ПЧ смесителя УКВ платы
* **VHF Mixer Current** - Выбор уровня тока смесителя
* **VHF TCXO, kHz** - Выбор частоты TCXO генератора УКВ платы
* **VHF TCXO Correction** - Поправка на отклонение частоты TCXO генератора УКВ платы

### Calibration RF Power
* **DAC Max Boost M1/2*** - Позволяют вывести ЦАП в режим максимальной выходной мощности в двух режимах работы. Mode 2 используется в диапазоне 46-65МГц, Mode 1 в остальных. Используйте с осторожностью и не допускайте перегрузки W2 VHF платы / HF драйверов. Не переключать при активной передаче
* **Power Control** - Задаёт способ изменения уровня сигнала ЦАП при регулировке мощности RF Power %: изменение мощности или изменение амплитуды сигнала
* **Sigmoid coeff** - Коэффициент наклона кривой регулировки мощности в режиме Power Control = Sigmoid
* **Use Power table** - Use the correction table to accurately set the % of maximum power, taking into account its gain nonlinearity (table calibration is performed in the service menu "Auto calibration" -> "Calibrate PWR %")
...
* **SD TX Record level** - Уровень записи собственного сигнала на карту памяти во время передачи / записи макроса
...
* **PA RF GAIN xxx** - Аналог RF GAIN, но для режима работы с внешним усилителем (EXT PA Mode)
...
* **MAX PWR Meter** - Максимальная выходная мощность (для индикации)
...
* **SWR ISO RATE** - Подстройка коэффициента компенсации плохой изоляции SWR-метра, когда прямая волна просачивается в обратную
...
* **WSPR Skip Cycles** - Пропуск циклов после каждого сеанса передачи
...
* **foF2** - Отображение карты критической частоты foF2 (требуется подключение к интернету)
* **Propagation Data** - Отображение статистики по прохождению радиоволн (требуется подключение к интернету)
* **Tropo** - Отображение прогноза тропосферного прохождения (требуется подключение к интернету)
* **Ionogram** - * Отображение ионограммы для выбранного URSI Code (требуется подключение к интернету)
* **VOACAP Map** - Карта распространения на КВ для текущего диапазона и QTH (требуется подключение к интернету)
...
* FT2 Приёмник / передатчик (ускоренный FT4, цикл T/R 3.75 с)
...
* Проверка тачпада, рисует холст, где можно проверить нажатия одним и двумя пальцами
...
* **Check sending skill** - Проверять ли навыки передачи после приёма каждой строки
* **CW Trainer Letters** - Тренировка приёма букв
* **CW Trainer Numbers** - Тренировка приёма цифр
* **CW Trainer Mixed** - Тренировка приёма букв + цифр

### Auto calibration

* **Calibrate SWR** - Помощник в калибровке КСВ и измерителя мощности
* **Calibrate RF GAIN** - Помощник в настройке выходной мощности
* **Calibrate PWR %** - Помощник в настройке таблицы поправок, для точной установки % выходной мощности с учётом нелинейности усиления (для работы функции/калибровки Use Power table)
* **ATU Runner** - Помощник в настройке автоматического тюнера, пробегает по всем включенным бендам / участкам и производит настройку
* **Pre-Distortion** - Настройки цифрового предыскажения

#### Pre-Distortion

* **DPD Enabled** - Активация системы цифровых предыскажений
* **DPD Calibration** - Запуск калибровки DPD для текущего бенда
* **DPD Reset** - Сброс калибровочных коэффициентов для текущего бенда
* **Draw chart** - Отобразить график применяемых искажений по амплитуде и фазе

* Функция экспериментальная, обязательно проверяйте свой сигнал по контрольному приёмнику после калибровки
* DPD предназначен для создания искусственно искаженного сигнала, который после прохождения через УМ компенсирует его нелинейности. В связи с этим уменьшаются IMD3 и IMD5 итогового сигнала
* Калибровка на каждый диапазон занимает примерно 30 секунд
* Калибровка может давать отличные результаты между попытками, всегда стоит контролировать результат и повторять, если необходимые параметры не были достигнуты
* После сброса коэффициентов DPD не оказывает влияния, полезно если необходимо отключить DPD для части бендов, но не отключать систему целиком
* Не допускайте высокого КСВ и перегрузки АЦП при калибровке. При необходимости используйте аттенюатор и цепь обратной связи с выхода УМ на вход RX
* При изменении настроек УМ (ток покоя, мощность раскачки) необходимо выполнить калибровку повторно
* Возможен слабый рост IMD7 и более высоких порядков за счёт компенсации IMD3/5
* Результат зависит от типов нелинейности УМ, от высокого уровня RF Gain калибровок, от качества обратной связи (аттенюатор 50db+ между выходом УМ и входом RX предпочтительней чем ёмкостная связь внутри трансивера)

### Web Skimmers 

* **Pskreporter** - Просмотр скиммеров, принявших ваш DIGI сигнал (требуется подключение к интернету)
* **ReverseBeacon** - Просмотр скиммеров, принявших ваш CW сигнал (требуется подключение к интернету)
* **WSPRnet** - Просмотр скиммеров, принявших ваш WSPR сигнал (требуется подключение к интернету)
